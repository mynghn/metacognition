...
- Runner contract: `./selftest-gate --all`, `./selftest-gate --staged`, `./selftest-gate --install-pre-commit`; fixed suite is `scripts/install-selftest`, `scripts/generate-selftest`, `scripts/maintenance-selftest`, `scripts/health-check-selftest`, `scripts/no-net-loss-selftest`, `engine/selftest`.
...
- Do not call `scripts/install-selftest --update-divergence` from automatic enforcement.
...
- Existing command surfaces: `scripts/install-selftest`, `scripts/generate-selftest`, `scripts/maintenance-selftest`, `scripts/health-check-selftest`, `scripts/no-net-loss-selftest`, `engine/selftest`
