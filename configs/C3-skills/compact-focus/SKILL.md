---
name: compact-focus
description: Use when the user asks to compact, clear, or condense the session, before a long context-heavy task, or to hand the user a focused compaction command — to generate a session-tailored `/compact <focus>` line so manual compaction keeps the working set and drops noise, in the context-engineering-knowledge-base spirit. The user runs /compact; you cannot.
---
